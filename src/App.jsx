...
export default function App() {
  ...
  const itensAlav=[
    {label:"À vista",color:C.avista,desembolso:alavValorBem,capitalFinal:alavCapAvista.final,mesInsuficiente:alavCapAvista.mesInsuficiente,aporteRendaTotal:alavCapAvista.aporteRendaTotal,saldoDevedor:0,valorAtivo:alavValorBem,patrimonioTotal:alavValorBem+alavCapAvista.final-alavCapAvista.aporteRendaTotal,capRows:alavCapAvista.rows},
